...
# --- Increase weight decay to reduce overfitting ---
print(f"\nOriginal weight_decay: {args.weight_decay}")
args.weight_decay = 0.005  # Increase from 0.001 to 0.005 to reduce overfitting
print(f"Updated weight_decay: {args.weight_decay}")
...
print(f"\nSGD optimizer created with:")
print(f"  Main LR: {args.lr_max}")
print(f"  Day LR: {args.lr_max_day}")
print(f"  Momentum: 0.9")
print(f"  Nesterov: True")
print(f"  Weight decay (other_params): {args.weight_decay} (increased from YAML default)")
